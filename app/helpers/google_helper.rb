module GoogleHelper
  ...
  def get_tokens(code)
    ...
    request.set_form_data({code: code, client_id: ENV['GOOGLE_CLIENT_ID'], client_secret: ENV['GOOGLE_CLIENT_SECRET'], redirect_uri: ENV['BASEURL'] + "oauth2callback", grant_type: "authorization_code" })
