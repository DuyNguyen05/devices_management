...
#     request.set_form_data({code: code, client_id: ApplicationController::CLIENT_ID, client_secret: ApplicationController::CLIENT_SECRET, redirect_uri: ApplicationController::BASEURL + "oauth2callback", grant_type: "authorization_code" })
